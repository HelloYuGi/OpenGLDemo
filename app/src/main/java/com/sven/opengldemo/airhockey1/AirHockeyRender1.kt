 ...
 *Describe:
 */
class AirHockeyRender1(val context: Context) : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceChanged(gl: GL10?, width: Int, height: Int) {
        ...
        if (width > height) {
            Matrix.orthoM(projectionMatrix, 0, -aspectRatio, aspectRatio, -1.5f, 1.5f, -1f, 1f)
        } else {
            Matrix.orthoM(projectionMatrix, 0, -1.5f, 1.5f, -aspectRatio, aspectRatio, -1f, 1f)
        }
    }
